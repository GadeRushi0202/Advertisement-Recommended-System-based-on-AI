                        ...
                        <div id="welcome" class="post">
                            ...
                            <table border="3">
                                ...
                                <%
                                    ...
                                    Statement st = db.st;
                                    ResultSet rs = st.executeQuery("select  a.orderid,a.items,a.date_,a.status,a.amount, b.email  from orders a, orderformurchats b where a.orderid=b.orderid and a.status!='Received' and b.email='"+mail+"'");
                                    while (rs.next()) {
                                %>
                                <tr>
